...
def generate_launch_description():
    ...
    pkg_urdf_path = FindPackageShare('step_01_robot_description')
    default_rviz_config_path = PathJoinSubstitution([pkg_urdf_path, 'rviz', 'agv_rviz.rviz'])
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'step_01_robot_description',
            'urdf_package_path': PathJoinSubstitution(['xacro_agv', LaunchConfiguration('model')]),
